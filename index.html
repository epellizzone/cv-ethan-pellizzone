...
<body>
    <main>
        ...
        <section class="container2">
            <div> <!-- présentation -->
                <h1 class="ethan">Ethan Pellizzone</h1>
                <p class="presentation">Bonjour, je m'appelle Ethan Pellizzone et j'ai 17 ans. Je suis actuellement en première année d'études en développement web. 
                    J'ai acquis des bases  en anglais, ce qui me permet de naviguer aisément dans un environnement anglophone.
            ...
            <!-- enseignement --->
            <div> 
                <h2 class="enseignement">ENSEIGNEMENT</h2>
                <div>
